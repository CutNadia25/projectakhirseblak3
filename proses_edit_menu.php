...
if (!empty($_POST['edit_menu_valid'])) {
    ...
    if ($statusUpload == 0) {
        ...
        window.location="../menu"</script>';
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $query = mysqli_query($conn, "UPDATE tb_daftar_menu SET foto='".$kode_rand. $_FILES['foto']['name']."', nama_menu='$nama_menu', keterangan='$keterangan', harga='$harga', stok='$stok', WHERE id='$id'");
                if ($query) {
